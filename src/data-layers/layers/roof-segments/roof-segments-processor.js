...
class RoofSegmentProcessor extends Processor {
   ...
   * @param {number} [options.minSegmentArea=5] - Minimum segment area in square meters
  ...
  async process(buildingInsights, options = {}) {
    try {
      return await this.timeOperation("process", async () => {
        ...
        const minSegmentArea = options.minSegmentArea || 5; // Default to 5 square meters minimum area
